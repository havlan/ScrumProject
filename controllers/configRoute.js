...
module.exports = function (app, passport) {
    ...
    app.get('/getAbsenceNum',isAdmin,getCtrl.getAbsenceNum);
    app.get('/getOvertimeNum',isAdmin,getCtrl.getOvertimeNum);
    app.get('/getChangeNum',isAdmin,getCtrl.getChangeNum);
